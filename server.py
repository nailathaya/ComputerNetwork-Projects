...
# Mengimpor modul threading, agar memungkinkan pengolahan beberapa koneksi klien secara bersamaan menggunakan thread
import threading

# Fungsi handle_client untuk menangani permintaan dari klien
def handle_client(client_socket): 
    ...
    try:
        ...
        response = response.encode('utf-8') + response_content
...
def main():
    ...
    while True:
        ...
        # Membuat thread baru untuk menangani permintaan klien menggunakan fungsi handle_client
